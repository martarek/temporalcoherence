...
if 5 != len(sys.argv):
    print "Usage: python run_nnet.py lr dc sizes seed batchsize "
    print ""
    print "Ex.: python run_nnet.py 0.1 0 [10,10,10,10] 1234 6"
    sys.exit()
...
trainset, validset, testset = dataset.get_classification_problem('../images/', int(sys.argv[4]))
